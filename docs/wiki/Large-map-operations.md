...
- Clear scoped railways, supply hubs, and generated building rows where applicable.

Review the action scope in the confirmation UI. A confirmation only verifies intent, not mod design correctness.
...
**[PLACEHOLDER: Add recovery instructions for a failed consolidation and a known-good small fixture mod.]**
